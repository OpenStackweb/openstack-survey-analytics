        ...
        return (
            <div id={'graph_' + name} className="col-md-12">
                ...
                >
                    ...
                    <YAxis type="category" dataKey="value" width={400} tick={{fontSize: 10}} interval={0} />
                    <Bar dataKey="value_count" fill="#0274b5" barSize={15} label={<CustomLabel char="%" rounded fill="#0274b5" position="right"/>} isAnimationActive={false} />
                </BarChart>
            </div>
        );
    }
